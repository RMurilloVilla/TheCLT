...
There are 3 main peaks. There are 2 semi-forming peaksat the side. This plot is trimodal because there are 3 distinctive peaks. The main peak (in the middle) is larger than the rest. It reaches about .025. The two at the side are the same size and reach at about .0175.
...
This is unimodal. Sense there is 1 distinctive peak. It reaches about .029. There is 3 minor peaks. All 4 peaks have different values, none of them are the same size.
...
Only 1 peak so there can't be a comparison in size.
...
This plot is unimodal. There is only 1 peak so there can't be a comparison in peaks.
